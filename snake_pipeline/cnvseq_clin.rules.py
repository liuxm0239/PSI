...
QDNASEQ="/root/conda/Genome/QDNAseq/qdnaseq.R"
QDNASEG="/root/conda/Genome/QDNAseq/qdnaseq_segment_calls.R"
...
rule QDNAseq:
	...
	#######################
        ...
        /root/conda/miniconda3/envs/Genomics/bin/Rscript {QDNASEQ} {wildcards.time}/s03_variant/qDNAseq/{wildcards.sample} {wildcards.time}/s03_variant/qDNAseq/{wildcards.sample} 100 {wildcards.sample}
        /root/conda/miniconda3/envs/Genomics/bin/Rscript {QDNASEG} {wildcards.time}/s03_variant/qDNAseq/{wildcards.sample}/{wildcards.sample}-binSize-100/{wildcards.sample}-copyNumbers-100kb-bins.rds {wildcards.time}/s03_variant/QDNAseq/{wildcards.sample} {wildcards.sample}
