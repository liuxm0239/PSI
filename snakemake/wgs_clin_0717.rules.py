...
rule gVCF:
    ...
    shell:"""
        ...
        xargs rm -rf < {wildcards.time}/s03_variant/GATK/{wildcards.sample}_input.list
        xargs rm -rf < {wildcards.time}/s03_variant/GATK/{wildcards.sample}_input.tbi.list
        #######################
        """
############
