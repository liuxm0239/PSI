...
SAMPLES={"SRR10583110", "SRR10583101", "SRR10583102", "SRR10583103", "SRR10583104", "SRR10583105", "SRR10583106", "SRR10583107", "SRR10583108", "SRR10583109", "SRR10583110"}
PLATFORM="MGISEQ"
...
PON="/root/conda/Genome/cnvkit/PoN/mouse_reference.cnn"
...
rule BWA:
	...
	bwa mem -M -Y -t {threads} -R '@RG\\tID:{wildcards.sample}\\tSM:{wildcards.sample}\\tLB:{wildcards.sample}\\tPL:{PLATFORM}' {REFERENCE} {input.R1} {input.R2} | samtools view -Sbh - -o {wildcards.time}/s02_alignment/s020_bwa/{wildcards.sample}.bam 2>{log}
