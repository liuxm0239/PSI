...
SAMPLES={"CGLAB20224231_S4", "CGLAB20224232_S5", "CGLAB20224233_S6", "CGLAB20224236_S8", "CGLAB20224237_S9", "CGLAB20224238_S10", "CGLAB20224369_S10", "CGLAB20224370_S9", "CGLAB20224372_S7", "CGLAB20224373_S6", "CGLAB20224376_S3", "CGLAB20224377_S2", "CGLAB20234765_S4", "CGLAB20234766_S5", "CGLAB20234767_S6", "CGLAB20234768_S7", "CGLAB20234769_S8", "CGLAB20234770_S9", "CGLAB20234771_S10", "CGLAB20234772_S11", "CGLAB20234773_S12", "CGLAB20234774_S13", "CGLAB20234775_S14", "CGLAB20234776_S15", "CGLAB20234777_S16", "CGLAB20234778_S17", "CGLAB20234779_S18", "CGLAB20234780_S19"}
...
rule all:
    input:
        ...
        #expand("{time}/s03_variant/clinSV/{sample}/SVs/joined/CNV.txt", sample=SAMPLES, time=TIME)
...
rule cnvkitPooled:
	...
	#######################
        #!/bin/bash
        {GATK} CollectInsertSizeMetrics -I {input.bam} \
                -O {wildcards.time}/s02_alignment/s022_Brecal/{wildcards.sample}_insert_size_metrics.txt\
                -H {wildcards.time}/s02_alignment/s022_Brecal/{wildcards.sample}_insert_size_metrics.pdf -M 0.5 2>>{log}

        samtools flagstat {input.bam} > {wildcards.time}/s02_alignment/s022_Brecal/{wildcards.sample}.BQSR.bam.stat 2>>{log}
        mkdir -p  {wildcards.time}/s02_alignment/s022_Brecal/{wildcards.sample}_mosdepth
        mosdepth -t {threads}  -b 5000 -Q 20 {wildcards.time}/s02_alignment/s022_Brecal/{wildcards.sample}_mosdepth/{wildcards.sample}_depth {input.bam} 2>>{log}
